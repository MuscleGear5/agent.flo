...
COMMANDS: dict[str, dict] = {
    ...
    "swarm": {
        ...
        "subs": {
            ...
            "scale":      {"desc": "Scale swarm agents",       "tool": "coordination_load_balance", "params": ["action", "task"]},
    ...
    "session": {
        ...
        "subs": {
            ...
            "save":    {"desc": "Save current session",   "tool": "session_save",    "params": ["name"]},
    ...
    "neural": {
        ...
        "subs": {
            ...
            "predict":   {"desc": "Make a prediction",       "tool": "neural_predict",   "params": ["input", "modelId"]},
            "optimize":  {"desc": "Optimize model",          "tool": "neural_optimize",  "params": ["modelId"]},
            "benchmark": {"desc": "Benchmark model",         "tool": "neural_benchmark", "params": ["modelId"]},
            "list":      {"desc": "List models",             "tool": "neural_list"},
            "export":    {"desc": "Export a model",          "tool": "neural_export",    "params": ["modelId"]},
            "import":    {"desc": "Import a model",          "tool": "neural_import",    "params": ["path"]},
            "autosetup": {"desc": "Auto-setup neural system", "tool": "neural_autosetup", "params": ["mode"]},
        },
    },
    "security": {
    ...
    "analyze": {
        ...
        "subs": {
            "diff":         {"desc": "Analyze a diff",            "tool": "analyze_diff",          "params": ["ref"]},
            "code":         {"desc": "Analyze code quality",      "tool": "analyze_file-risk",     "params": ["path"]},
            "deps":         {"desc": "Dependency analysis",       "tool": "analyze_diff-stats",    "params": ["ref"]},
            "ast":          {"desc": "AST analysis",              "tool": "analyze_file-risk",     "params": ["path"]},
            "complexity":   {"desc": "Complexity analysis",       "tool": "analyze_file-risk",     "params": ["path"]},
            "symbols":      {"desc": "Symbol analysis",           "tool": "analyze_file-risk",     "params": ["path"]},
            "imports":      {"desc": "Import graph analysis",     "tool": "analyze_file-risk",     "params": ["path"]},
            "boundaries":   {"desc": "Module boundary analysis",  "tool": "analyze_diff-classify", "params": ["ref"]},
            "modules":      {"desc": "Module structure analysis", "tool": "analyze_diff-stats",    "params": ["ref"]},
            "dependencies": {"desc": "Full dependency graph",     "tool": "analyze_diff-stats",    "params": ["ref"]},
            "circular":     {"desc": "Circular dependency check", "tool": "analyze_diff-stats",    "params": ["ref"]},
        },
    },
    "route": {
